...
class LogisticRegressionNet(nn.Module):
    ...
    def get_w(self):
        return self.weight - projection(self.weight)

if __name__ == "__main__":
    train_path = '.\datasets\\leu'
    test_path = '.\datasets\\leu.t'
    ...
    logreg = LogisticRegression(C=1/lam, penalty='l1', tol=tolerance, max_iter=max_itr, solver='liblinear')
    start = timeit.default_timer()
